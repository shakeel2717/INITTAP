...
final class AllPayment extends PowerGridComponent
{
    use ActionButton;
    ...
    */
    ...
    {
        return Transaction::query()->where('corporate_id', session('corporate')->id)->where('type', 'deposit');
    }
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ->addColumn('sum')
            ->addColumn('status_check', function ($model) {
                return $model->status ? '<span class="badge badge-success">Complete</span>' : '<span class="badge badge-warning">Pending</span>';
            })
            ->addColumn('reference')
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('STATUS', 'status_check'),
